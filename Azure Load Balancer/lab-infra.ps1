...
$Params = @{
    ...
    Settings          = @{fileUris = @('https://raw.githubusercontent.com/Sarfaraz-diconium123/azure-pub-load-balancer/main/Azure%20Load%20Balancer/sample.html'); commandToExecute = './jumpbox.sh'}
}
